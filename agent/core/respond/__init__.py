...
from agent.core.respond.input_senses.senses import Senses
from agent.core.respond.output_action.action import Action
from agent.core.respond.output_action.output_interface import OutputProtocol
