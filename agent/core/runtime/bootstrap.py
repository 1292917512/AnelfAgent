...
def create_bootstrap() -> FlowMachine:
    ...
    async def init_storage():
        from agent.core.storage.data_center import create_data_center
    ...
    async def init_channel_system():
        """初始化频道管理器和输入管道。"""
        from agent.core.channel import ChannelManager, InputPipeline, get_channel_manager
    ...
    async def init_persona():
        from agent.core.runtime.factory import load_persona
        char = load_persona()
        return char
    ...
    async def init_memory():
        ...
        from agent.core.mind.memory.memory_migrate import needs_migration, migrate_memories_to_md
        from agent.core.mind.memory.memory_sync import sync_files
        from agent.core.storage.sqlite_backend import default_sqlite_path
        from core.lifecycle import Lifecycle
    ...
    async def register_internal_tools():
        from agent.core.mind.memory.notes import register_notes_tools
        from agent.core.mind.memory.tools import register_memory_tools
        from agent.core.mind.planning import register_planning_tools
        from agent.core.channel.output_tools import register_output_tools
        from agent.core.mind.multi_tool import register_multi_tool
    ...
    async def assemble_runtime():
        ...
        from agent.core.runtime.singleton import set_runtime
        ...
        from agent.core.mind.multi_tool import set_mind
        set_mind(mind)
    ...
    async def start_agent():
        ...
        from agent.core.runtime.singleton import get_runtime
