...
class StorageRouter:
    ...
    async def _append_conversation(self, *, scope_type: str, scope_id: str, role: str, content: str, ts_ns: Optional[int] = None, adapter_key: str = "", trigger_mind: bool = True, **_kw: Any) -> None:
        await self.sqlite.append_conversation(scope_type=scope_type, scope_id=scope_id, role=role, content=content, ts_ns=ts_ns, adapter_key=adapter_key, trigger_mind=trigger_mind)
