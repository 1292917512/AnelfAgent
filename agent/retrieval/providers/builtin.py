...
实现底座在 agent/retrieval/fetcher.py（SSRF 防护 / robots 合规 / 正文提取管线）。
"""
...
from agent.retrieval.providers.base import Provider
...
class BuiltinProvider(Provider):
    ...
    def read(
        ...
        *,
        ...
        from agent.retrieval.fetcher import read_page
        return read_page(
    ...
    def error_response(self, exc: Exception, action: str, hint: str = "") -> str:
        from agent.retrieval.fetcher import RobotsDisallowed
