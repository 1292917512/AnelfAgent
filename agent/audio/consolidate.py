...
def insignificant_limits() -> tuple[int, int]:
    ...
    """
    return (
        get_config_int("audio_insignificant_max_matches", 2),
        get_config_int("audio_insignificant_max_audio_ms", 5000),
    )
        ...
        for cluster in clusters:
            ...
            for member in cluster["members"]:
                ...
                try:
                    ...
                    log(f"合并跳过 [{member['speaker_key']}]: {exc}", "WARNING", tag=_LOG_TAG)
